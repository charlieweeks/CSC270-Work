  ...
  */
	case class HtmlCorpus(
		...
		def html: String = {
			...
			<!-- We added this to make it use unicode characters -->
			<meta charset="utf-8"/>
			...
			<br />
			This work (<span property="dct:title">The Count of Monte Cristo</span>, by <span resource="[_:creator]" rel="dct:creator"><span property="dct:title">Alexandre Dumas</span></span>), identified by <span resource="[_:publisher]" rel="dct:publisher"><span property="dct:title">Charlie Weeks</span></span>, is free of known copyright restrictions.
			</p>
			</body>
			</html>
			"""
	...
	*/
	def landingPage( vcorp: Vector[HtmlCorpus]): Unit = {
		...
		val infoString: String = """<div class="cts_siteDesc">Language: English. Anonymous translation first published by Chapman and Hall in 1864. Original (French) published August 28th, 1844 through January 15th, 1846, serialization. This digital edition was assembled by Christopher Blackwell, Ph.D., and Charlie Weeks. Plain-text, citable, following the protocols of the CITE Architecture.</div>"""
